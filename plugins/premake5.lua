...
project "mag_voxel"
    location "build/mag_voxel"
    targetname "mag_voxel"
    kind "SharedLib"
    language "C++"
    sysincludedirs {".."}
    files {"mag_voxel/*.inl", "mag_voxel/*.h", "mag_voxel/*.c"}

project "mag_terrain_component"
    location "build/mag_terrain_component"
    targetname "mag_terrain_component"
    kind "SharedLib"
    language "C++"
    sysincludedirs {".."}
...
project "mag_async_gpu_queue"
    location "build/mag_async_gpu_queue"
    targetname "mag_async_gpu_queue"
    kind "SharedLib"
    language "C++"
    sysincludedirs {".."}
